...
export function Hero() {
  return (
    <section id="home" className="relative overflow-hidden pb-24 pt-20 sm:pb-32 sm:pt-28 lg:pb-40 lg:pt-32">
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-[52rem] text-center">
          ...
          <p className="mx-auto mt-8 max-w-xl text-base leading-relaxed text-muted-foreground sm:mt-10 sm:text-xl">
        ...
        <div className="mx-auto mt-20 grid max-w-4xl grid-cols-2 gap-px overflow-hidden rounded-2xl border border-border bg-border sm:mt-28 sm:grid-cols-4">
          {STATS.map((stat) => (
